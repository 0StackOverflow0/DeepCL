...
NeuralNet *NeuralNet::clone() {
    ...
    copy->print();
    cout << "outputimageheight: " << copy->getOutputSize().height << endl;
    cout << "outputimagewidth: " << copy->getOutputSize().width << endl;
    return copy;
}
...
PUBLICAPI VIRTUAL Dimensions NeuralNet::getOutputSize() const {
