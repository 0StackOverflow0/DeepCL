...
BackpropWeightsNaive::BackpropWeightsNaive(EasyCL *cl, LayerDimensions dim) :
    ...
    "    if (globalId >= gNumFilters * gInputPlanes * gFilterHeight * gFilterWidth) {\n"
    "        return;\n"
    "    }\n"
    "\n"
    "    int IntraFilterOffset = globalId % gFilterArea;\n"
    "    int filterRow = IntraFilterOffset / gFilterWidth;\n"
    "    int filterCol = IntraFilterOffset % gFilterWidth;\n"
    "\n"
    "    int filter2Id = globalId / gFilterArea;\n"
    ...
    "                bool proceed = upstreamRow >= 0 && upstreamCol >= 0 && upstreamRow < gInputHeight\n"
    "                    && upstreamCol < gInputWidth;\n"
    "                if (proceed) {\n"
    ...
    "                                     + upstreamPlane) * gInputHeight\n"
    "                                     + upstreamRow) * gInputWidth\n"
    "                                     + upstreamCol;\n"
